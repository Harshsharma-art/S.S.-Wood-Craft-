  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Premium wooden doors, windows, PVC panels and complete interior works in Moradabad by S.S. WoodCraft Private Limited.",
      },
      { name: "author", content: "S.S. WoodCraft Private Limited" },
